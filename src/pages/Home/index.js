...
const Page = () => {
  ...
  /* création d'une fonction pour récupérer l'objet le plus récents du tableau events */
  const last =
  data && data.events
  ...
  return <>
    ...
    <main>
      ...
      <section className="ServicesContainer">
        <h2 className="Title" id="nos-services">Nos services</h2> {/* ajout de l'id correspondant au lien de la barre de navigation */}
      ...
      <section className="EventsContainer">
        <h2 className="Title" id="nos-realisations">Nos réalisations</h2>{/* ajout de l'id correspondant au lien de la barre de navigation */}
        <EventList />
      </section>
      <section className="PeoplesContainer">
        <h2 className="Title" id="notre-equipe">Notre équipe</h2>{/* ajout de l'id correspondant au lien de la barre de navigation */}
    ...
    <footer className="row">
      <div className="col presta">
        ...
        <EventCard
          imageSrc={last?.cover || ""} /* ajout de l'opérateur logique || "" pour assurer que la valeur de cover et title soit toujours une chaîne de caractère et ne renvoi pas d'erreur  */
          title={last?.title || ""} /* ajout de l'opérateur logique || "" pour assurer que la valeur de cover et title soit toujours une chaîne de caractère et ne renvoi pas d'erreur  */
